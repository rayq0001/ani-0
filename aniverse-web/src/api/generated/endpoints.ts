...
export const API_ENDPOINTS = {
    AI: {
        GetAISettings: {
            key: "AI-get-a-i-settings",
            methods: ["GET"],
            endpoint: "/api/v1/ai/settings",
        },
        UpdateAISettings: {
            key: "AI-update-a-i-settings",
            methods: ["POST"],
            endpoint: "/api/v1/ai/settings",
        },
        /**
         *  @description
         *  Route performs OCR on a manga page image.
        ...
        GenerateRecap: {
            key: "AI-generate-recap",
            methods: ["POST"],
            endpoint: "/api/v1/ai/recap",
        },
        AIVibeSearch: {
            key: "AI-a-i-vibe-search",
            methods: ["POST"],
            endpoint: "/api/v1/ai/search",
        },
        GenerateLoreTree: {
            key: "AI-generate-lore-tree",
            methods: ["POST"],
            endpoint: "/api/v1/ai/lore",
        },
        UpscaleImage: {
            key: "AI-upscale-image",
            methods: ["POST"],
    ...
    COMICS: {
        /**
         *  @description
         *  Route returns the user's comics collection organized by type.
         *  This endpoint returns all comics (manga, manhwa, manhua) organized by type with enhanced data.
         */
        GetComicsCollection: {
            key: "COMICS-get-comics-collection",
            methods: ["POST"],
            endpoint: "/api/v1/comics/collection",
        },
        GetComicsStats: {
            key: "COMICS-get-comics-stats",
            methods: ["GET"],
            endpoint: "/api/v1/comics/stats",
        },
        GetComicsByType: {
            key: "COMICS-get-comics-by-type",
            methods: ["GET"],
    ...
    NAKAMA: {
        ...
        /**
         *  @description
         *  Route creates a Aniverse Room and connects to it as host.
         *  This creates a room on the Aniverse Rooms relay server and connects as the host. Peers can then join using the returned URL.
         */
    ...
    SPACE: {
        CosmicSearch: {
            key: "SPACE-cosmic-search",
            methods: ["POST"],
            endpoint: "/api/v1/anyverse/cosmic-search",
        },
        GetGalaxyClusters: {
            key: "SPACE-get-galaxy-clusters",
            methods: ["GET"],
            endpoint: "/api/v1/anyverse/galaxy-clusters",
        },
        GetSimilarGalaxies: {
            key: "SPACE-get-similar-galaxies",
            methods: ["GET"],
            endpoint: "/api/v1/anyverse/similar-galaxies/:id",
        },
        GetTimeline: {
            key: "SPACE-get-timeline",
            methods: ["GET"],
            endpoint: "/api/v1/anyverse/timeline/:id",
        },
        VisualSearch: {
            key: "SPACE-visual-search",
            methods: ["POST"],
            endpoint: "/api/v1/anyverse/visual-search",
        },
        EmotionalSearch: {
            key: "SPACE-emotional-search",
            methods: ["POST"],
    ...
    STATUS: {
         ...
         *  This returns the content of the most recent aniverse- log file after flushing logs.
         */
        GetLatestLogContent: {
