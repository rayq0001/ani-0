...
/**
 * - Filepath: internal/handlers/ai.go
 * - Filename: ai.go
 * - Endpoint: /api/v1/ai/settings
 * @description
 * Route updates the AI service settings.
 */
export type UpdateAISettings_Variables = {
    geminiApiKey: string
    openaiApiKey: string
 ...
 * @description
 * Route translates text using AI.
 */
export type TranslateText_Variables = {
    text: string
    sourceLang: string
    targetLang: string
}
 ...
 * @description
 * Route generates a lore tree for a manga.
 */
export type GenerateLoreTree_Variables = {
    mediaId: number
    title: string
    chapters: string
}
 ...
 * @description
 * Route upscales a manga page image.
 */
export type UpscaleImage_Variables = {
    imageBase64: string
    mimeType: string
    scale: number
}
...
/**
 * - Filepath: internal/handlers/anyverse.go
 * - Filename: anyverse.go
 * - Endpoint: /api/v1/anyverse/summary
 * @description
 * Route generates a smart summary of previously read chapters
 */
export type GenerateSmartSummary_Variables = {
    mediaId: number
    mangaTitle: string
    chaptersRead: Array<number>
    lastChapter: number
    lastReadAt: string
    language: string
 ...
 * @description
 * Route queues a chapter for offline download
 */
export type QueueDownload_Variables = {
    mediaId: number
    mangaTitle: string
    chapter: number
    pageCount: number
 ...
 * @description
 * Route queues next chapters for offline reading
 */
export type QueueNextChapters_Variables = {
    mediaId: number
    mangaTitle: string
 ...
 * @description
 * Route pauses a download
 */
export type PauseDownload_Variables = {
    downloadId: string
}
 ...
 * @description
 * Route resumes a download
 */
export type ResumeDownload_Variables = {
    downloadId: string
}
 ...
 * @description
 * Route cancels a download
 */
export type CancelDownload_Variables = {
    downloadId: string
}
 ...
 * @description
 * Route localizes text to Arabic dialect
 */
export type CulturalLocalization_Variables = {
    text: string
 ...
 * @description
 * Route generates customized voice
 */
export type VoiceCustomization_Variables = {
    text: string
    voiceType: string
    emotion: string
    speed: number
 ...
 * @description
 * Route generates AI-directed perspective
 */
export type AIDirector_Variables = {
    imageBase64: string
 ...
 * @description
 * Route generates emotional OST
 */
export type GenerateOST_Variables = {
    mood: string
 ...
 * @description
 * Route upgrades subscription
 */
export type UpgradeSubscription_Variables = {
    tier: string
 ...
 * @description
 * Route purchases AnyCoins
 */
export type PurchaseCoins_Variables = {
    packageId: string
    paymentMethod: string
}
...
/**
 * - Filepath: internal/handlers/comics.go
 * - Filename: comics.go
 * - Endpoint: /api/v1/comics/{type}
 * @description
 * Route returns comics of a specific type.
 */
export type GetComicsByType_Variables = {
    /**
     *  Type of comics (manga, manhwa, manhua)
     */
    type: string
}
