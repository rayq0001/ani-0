            ...
            >
                ...
                >
                    ...
                    {!ts.disableSidebarTransparency && <div
                        data-library-header-banner-top-gradient
                        className="hidden lg:block h-full absolute z-[2] w-[30%] opacity-40 left-0 top-0 bg-gradient-to-r from-purple-900 via-purple-950/20 to-transparent"
                    />}

                    <div
                        data-library-header-banner-bottom-gradient
                        className="w-full z-[3] opacity-80 lg:opacity-60 absolute top-0 h-[8rem] bg-gradient-to-b from-black via-purple-950/30 via-80% to-transparent"
                    />
