...
import { EpisodeSmartSummary } from "@/app/(main)/_features/ai-features/smart-summary-button"
    ...
    return (
        <>
            ...
            >
                ...
                {/* Smart Summary Button for Manga */}
                {!!selectedChapter && !!entry?.media && (
                    <div className="hidden md:flex items-center ml-2">
                        <EpisodeSmartSummary
                            episodeNumber={Number(selectedChapter.chapterNumber)}
                            episodeTitle={`Chapter ${selectedChapter.chapterNumber}`}
