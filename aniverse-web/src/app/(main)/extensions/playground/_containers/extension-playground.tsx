                                                ...
                                                {type === "manga-provider" && (
                                                    <>
                                                        ...
                                                        {selectedFunction === Functions.MangaProviderSearch && (
                                                            <>
                                                                <Alert intent="info">
                                                                    Aniverse will automatically select the best match based on the manga titles.
                                                                </Alert>
                                                            </>
                                                        )}
                                                        ...
                                                        {selectedFunction === Functions.OnlinestreamSearch && (
                                                            <>
                                                                <Alert intent="info" className="text-sm">
                                                                    Aniverse will automatically select the best match based on the anime titles.
                                                                </Alert>
