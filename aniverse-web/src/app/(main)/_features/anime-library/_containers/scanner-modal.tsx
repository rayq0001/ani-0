...
export function ScannerModal() {
    ...
    try {
        return <ScannerModalContent />
    } catch (error) {
        console.error("ScannerModal error:", error)
        return null
    }
}
                        ...
                        <AppLayoutStack className="space-y-2">
                            ...
                            {!anilistDataOnly.active && <RadioGroup
                                ...
                                help={enhanceWithOfflineDatabase.active
                                    ...
                                    : <span><span className="text-[--orange]">Slower for large libraries</span>. Aniverse will send an API request for
