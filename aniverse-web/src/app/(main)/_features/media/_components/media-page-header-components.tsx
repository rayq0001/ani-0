...
import { SmartSummaryButton } from "@/app/(main)/_features/ai-features/smart-summary-button"
        ...
        <>
            <div className="flex flex-col lg:flex-row gap-8" data-media-page-header-entry-details>
                ...
                >
                    ...
                    {ts.mediaPageBannerSize !== ThemeMediaPageBannerSize.Small && <div className="flex items-start gap-2">
                        <Popover
                            trigger={<div
                                className={cn(
                                    ...
                                    "bg-transparent rounded-[--radius-md] text-center lg:text-left group/description",
                                )}
                                data-media-page-header-details-description-trigger
                            >
                                <span className="group-hover/description:text-[--brand] transition-colors">
                        ...
                        {/* Smart Summary Button for Story/Synopsis */}
                        {media?.id && (
                            <SmartSummaryButton
                                mediaId={media.id}
                                title={title || ""}
