...
import { LuBookOpen, LuBrain, LuCalendar, LuCompass, LuRefreshCw, LuRss, LuSettings } from "react-icons/lu"
...
function SidebarNavigation({ isCollapsed, containerRef }: { isCollapsed: boolean, containerRef: React.RefObject<HTMLDivElement> }) {
    ...
    const activeAIToolsCount = [
        aiSettings?.enableChat,
        aiSettings?.enableRecap,
        aiSettings?.enableSearch,
        aiSettings?.enableOcr,
    ...
    const items = React.useMemo(() => [
        ...
        }] : [],
        {
            ...
            name: "Comics",
            href: "/comics",
            isCurrent: pathname.startsWith("/comics"),
        },
        {
            id: "lists",
        ...
        // AI Tools Menu Item
        {
            ...
            name: "AI Tools",
            href: "/ai-tools",
            isCurrent: pathname === "/ai-tools",
            addon: activeAIToolsCount > 0 ? <Badge
                className="absolute right-0 top-0 bg-violet-500" size="sm"
                intent="info-solid"
            >{activeAIToolsCount}</Badge> : undefined,
        },
        // AI Services Menu Item
        {
            id: "ai-services",
            iconType: LuBrain,
            name: "AI Services",
            href: "/ai-services",
            isCurrent: pathname === "/ai-services",
            addon: aiSettings?.enableChat ? <Badge
                className="absolute right-0 top-0 bg-blue-500" size="sm"
                intent="info-solid"
            >●</Badge> : undefined,
        },
        // Anyverse Hub Menu Item
        {
            id: "anyverse",
            iconType: LuCompass,
            name: "Anyverse",
            href: "/anyverse",
            isCurrent: pathname === "/anyverse",
        },
        // Unlimited Space Menu Item
        {
            id: "space",
            iconType: IoCloudOfflineOutline,
            name: "Unlimited Space",
            href: "/space",
            isCurrent: pathname === "/space",
        },
        ...(
