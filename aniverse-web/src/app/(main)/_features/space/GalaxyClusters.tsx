  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="mb-6">
        ...
        <p className="text-white/60">Explore works classified in galactic groups by genre and similarity</p>
      </div>
      ...
      <div className="flex-1 grid grid-cols-2 lg:grid-cols-3 gap-6 overflow-y-auto pb-20">
            ...
            >
              ...
              <div className="relative z-10 p-6 h-full flex flex-col">
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-xs text-white/40 mr-2">+More</span>
                </div>
        ...
        >
          <GlassCard className="h-full flex flex-col items-center justify-center p-6 border-dashed border-2 border-purple-500/30 hover:border-purple-500/60 cursor-pointer transition-colors">
            ...
            <h3 className="text-lg font-bold text-white mb-2">Custom Galaxy</h3>
            <p className="text-sm text-white/50 text-center mb-4">
              Create your own collection of favorite works
            </p>
      ...
      >
        <GlassCard className="p-6 relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div>
              <h3 className="text-xl font-bold text-white mb-2">✨ Discovery of the Day</h3>
              <p className="text-white/70">"Heroes of the System" Galaxy - works similar to Solo Leveling by 85%</p>
            </div>
            <motion.button
