...
const STORY_GENES = [
  { id: 'system', label: 'System', icon: '⚙️', color: 'blue' },
  { id: 'leveling', label: 'Leveling', icon: '📈', color: 'green' },
  { id: 'shadow-monarch', label: 'Shadow Monarch', icon: '👑', color: 'purple' },
  { id: 'dungeons', label: 'Dungeons', icon: '🏰', color: 'red' },
  { id: 'summoning', label: 'Summoning', icon: '🔮', color: 'indigo' },
  { id: 'regression', label: 'Time Regression', icon: '⏰', color: 'cyan' },
  { id: 'tower', label: 'Tower', icon: '🗼', color: 'orange' },
  { id: 'reincarnation', label: 'Reincarnation', icon: '✨', color: 'pink' },
  { id: 'betrayal', label: 'Betrayal', icon: '🗡️', color: 'red' },
  { id: 'guild', label: 'Guild', icon: '🏛️', color: 'yellow' },
  { id: 'academy', label: 'Academy', icon: '🎓', color: 'blue' },
  { id: 'romance', label: 'Romance', icon: '💕', color: 'pink' },
  { id: 'comedy', label: 'Comedy', icon: '😄', color: 'yellow' },
  { id: 'dark', label: 'Dark', icon: '🌑', color: 'gray' },
  { id: 'politics', label: 'Politics', icon: '⚖️', color: 'purple' },
  { id: 'war', label: 'War', icon: '⚔️', color: 'red' },
];
    ...
    <GlassCard className="w-96 h-full flex flex-col overflow-hidden border-purple-500/30">
      ...
      <div className="p-4 border-b border-white/10 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-white">Gene Filter</h2>
        </div>
        <button
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        {selectedGenes.length > 0 && (
          <div className="p-3 bg-purple-500/10 rounded-lg border border-purple-500/30">
            <p className="text-xs text-purple-300 mb-2">Selected Genes:</p>
      ...
      <div className="p-4 border-t border-white/10">
        ...
        <p className="text-center text-xs text-white/40 mt-2">
          A custom cosmic space will be created based on your choices
        </p>
      </div>
    </GlassCard>
  );
