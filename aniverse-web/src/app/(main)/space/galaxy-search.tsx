    ...
    const handleSearch = useCallback(async () => {
        ...
        setPlanetData({
            anime: {
                ...
                episodes: 1070,
                status: 'Ongoing',
                synopsis: 'An epic story about pirates searching for a legendary treasure'
            },
            manga: {
            ...
            aiStory: `In a distant world, where seas clash and dreams come true...

There was a young pirate named Luffy, who dreamed of becoming the Pirate King. On his journey, he met loyal friends and faced powerful enemies.

"Freedom is the most precious thing in the world" - this was always his motto.

One day, Luffy discovered an ancient secret related to the history of the lost world, leading him to a new adventure full of dangers and discoveries...`
        })
                ...
                <AnimatePresence mode="wait">
                    {!showPlanet ? (
                        ...
                        >
                            ...
                            >
                                Discover anime and manga worlds in visual galaxies
                            </motion.p>
                            ...
                            >
                                <div className="relative group">
                                    <input
                                        ...
                                        placeholder="Search for anime, manga, or novel..."
                                ...
                                >
                                    <span className="text-white/30 text-sm">Suggestions:</span>
                                    {['One Piece', 'Naruto', 'Attack on Titan', 'Demon Slayer'].map((suggestion) => (
                                        <button
                                            key={suggestion}
                                            onClick={() => {
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between mb-8">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-white/40 text-sm">Explore related content</p>
                                </div>
                            ...
                            <div className="relative flex items-center justify-center mb-12">
                                ...
                                {/* Satellites */}
                                {[
                                    { id: 'anime', icon: LuTv, label: 'Anime', color: 'from-blue-500 to-cyan-500', angle: 0 },
                                    { id: 'manga', icon: LuBookOpen, label: 'Manga', color: 'from-violet-500 to-purple-500', angle: 90 },
                                    { id: 'novel', icon: LuFileText, label: 'Novel', color: 'from-pink-500 to-rose-500', angle: 180 },
                                    { id: 'story', icon: LuWand, label: 'AI Story', color: 'from-amber-500 to-orange-500', angle: 270 },
                                ].map((satellite, index) => {
                                        ...
                                        >
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center gap-6 mb-4 text-white/60">
                                                    ...
                                                    <span>📺 {planetData.anime.episodes} Episodes</span>
                                                </div>
                                    ...
                                    {selectedSatellite === 'manga' && planetData?.manga && (
                                        ...
                                        >
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center gap-6 mb-4 text-white/60">
                                                    <span>📖 {planetData.manga.chapters} Chapters</span>
                                                    <span className="px-3 py-1 rounded-full bg-green-500/20 text-green-400 text-sm">
                                    ...
                                    {selectedSatellite === 'novel' && planetData?.novel && (
                                        ...
                                        >
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center gap-6 mb-4 text-white/60">
                                                    <span>📚 {planetData.novel.chapters} Chapters</span>
                                    ...
                                    {selectedSatellite === 'story' && planetData?.aiStory && (
                                        ...
                                        >
                                            <div className="flex items-center gap-3 mb-6">
                                                ...
                                                <div>
                                                    <h3 className="text-xl font-bold text-white">Original Story by AI</h3>
                                                    <p className="text-white/40 text-sm">Inspired by the world of {searchQuery}</p>
                                                </div>
                                            </div>
