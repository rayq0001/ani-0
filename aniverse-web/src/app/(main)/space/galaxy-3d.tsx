...
export function Galaxy3D({ onSearch }: Galaxy3DProps) {
  ...
  const generatePlanetData = async (query: string) => {
    ...
    const mockData: PlanetData = {
      name: query,
      type: activeTab,
      description: `The world of ${query} is a planet full of adventures and secrets, where heroes and villains intersect in epic conflicts.`,
      tags: ["Adventure", "Fantasy", "Action", "Drama"],
      aiStory: `In the depths of planet ${query}, epic events of matchless courage and time-defying friendship unfold. The hero leads an exploratory journey through unknown realms, discovering supernatural powers and centuries-old secrets. At every step, he faces challenges that test his will, but he learns that true strength comes from the bonds he builds with his companions. This story is not just an adventure, but a journey of self-discovery and finding the true meaning of heroism.`,
    ...
    setIsLoading(false)
    toast.success(`Planet ${query} found!`)
  }
      ...
      <AnimatePresence>
        {!showPlanet && (
          ...
          >
            ...
            >
              Discover new worlds by searching the galaxy
            </motion.p>
            ...
            >
              <div className="relative">
                <input
                  ...
                  placeholder="Search for a planet (e.g., One Piece)..."
        ...
        {showPlanet && selectedPlanet && (
          ...
          >
            <div className="p-8">
              ...
              >
              {[
                { id: "anime" as const, icon: LuTv, label: "Anime" },
                { id: "manga" as const, icon: LuBookOpen, label: "Manga" },
                { id: "novel" as const, icon: LuFileText, label: "Novel" },
                { id: "ai-story" as const, icon: LuWand, label: "AI Story" }
              ].map((tab) => {
              ...
              >
                <div className="bg-white/5 rounded-xl p-4 text-center border border-white/10">
                  ...
                  <div className="text-white/50 text-sm">Episode</div>
                </div>
                <div className="bg-white/5 rounded-xl p-4 text-center border border-white/10">
                  <div className="text-2xl font-bold text-blue-400">
                    {selectedPlanet.chapters}
                  </div>
                  <div className="text-white/50 text-sm">Chapter</div>
                </div>
                <div className="bg-white/5 rounded-xl p-4 text-center border border-white/10">
              ...
              >
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-white font-semibold">AI Story</h3>
                </div>
