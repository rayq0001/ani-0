...
export default function _page() {
    ...
    // text-lg">Connect your MyAnimeList account to Aniverse</p> <Button onClick={() => { window.open(OAUTH_URL, "_self") }} intent="primary"
    ...
    // MyAnimeList account to Aniverse</p> <p className="text-[--muted]"> Due to authentication restrictions, you can only connect your MyAnimeList
    ...
    return (
        <div className="p-12 pt-0 space-y-0">
            ...
            {/*    <p>*/}
            {/*        Your MyAnimeList account is connected to Aniverse.*/}
            {/*    </p>*/}
            ...
            {/*            Your progress will be automatically updated on MAL whenever you watch an episode or read a chapter with Aniverse.*/}
            {/*        </span></li>*/}
