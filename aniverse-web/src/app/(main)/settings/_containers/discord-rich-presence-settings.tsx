    ...
    return (
        <>
            <SettingsCard title="Rich Presence" description="Show what you are watching or reading in Discord.">
                ...
                <Field.Switch
                    side="right"
                    name="richPresenceHideAniverseRepositoryButton"
                    label="Hide Aniverse Repository Button"
                />
                ...
                {/*    help="Replace 'Aniverse' with the media title in the activity status. Only works if you use a discord client that utilizes arRPC."*/}
                {/*/>*/}
            </SettingsCard>
        </>
    )
