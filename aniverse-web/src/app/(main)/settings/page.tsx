...
import { AISettingsContainer } from "./_containers/ai-settings"
                            ...
                            <div className="overflow-x-none overflow-y-hidden rounded-[--radius-md] space-y-1 lg:space-y-3 flex justify-center flex-wrap lg:block">
                                ...
                                <Card className="lg:p-2 contents lg:block border-0 bg-transparent lg:border lg:bg-gray-950/80">
                                    ...
                                    <TabsTrigger
                                        value="ai"
                                        className="group"
                                    ><LuSparkles className="text-xl mr-3 transition-transform duration-200" /> AI</TabsTrigger>
                                </Card>
                    ...
                    <div className="">
                        <Form
                            ...
                            onSubmit={data => {
                                mutate({
                                    ...
                                    discord: {
                                        ...
                                        richPresenceHideaniverseRepositoryButton: data?.richPresenceHideaniverseRepositoryButton ?? false,
                            ...
                            defaultValues={{
                                ...
                                richPresenceHideaniverseRepositoryButton: status?.settings?.discord?.richPresenceHideaniverseRepositoryButton ?? false,
                        ...
                        >
                            {(f) => {
                                return <>
                                    <SettingsIsDirty />
                                    <TabsContent value="aniverse" className={tabContentClass}>
                                            ...
                                            <AccordionItem value="qbittorrent">
                                                ...
                                                <AccordionContent className="p-0 py-4 space-y-4">
                                                    ...
                                                    <Field.Text
                                                        ...
                                                        label="Tags"
                                                        help="Comma separated tags to apply to downloaded torrents. e.g. aniverse,anime"
                                                    />
                                                    <Field.Text
