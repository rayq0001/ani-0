...
function WebsocketManagement() {
    ...
    const [cookies, setCookie, removeCookie] = useCookies(["Aniverse-Client-Id"])
    ...
    React.useEffect(() => {
        logger("WebsocketProvider").info("Aniverse-Client-Id", cookies["Aniverse-Client-Id"])
        if (cookies["Aniverse-Client-Id"]) {
            setClientId(cookies["Aniverse-Client-Id"])
        }
    }, [cookies])
    ...
    useEffectOnce(() => {
        ...
        function connectWebSocket() {
            ...
            const clientId = cookies["Aniverse-Client-Id"] || uuidv4()
            ...
            try {
                ...
                socketRef.current.addEventListener("open", () => {
                    ...
                    if (!cookies["Aniverse-Client-Id"]) {
                        setCookie("Aniverse-Client-Id", clientId, {
                            path: "/",
                            sameSite: "lax",
                            secure: false,
