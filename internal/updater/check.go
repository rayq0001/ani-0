...
// This allows updates even if aniverse is removed from GitHub
var (
	websiteUrl        = "https://aniverse.app/api/release"
	fallbackGithubUrl = "https://api.github.com/repos/5rahim/aniverse/releases/latest"
)
