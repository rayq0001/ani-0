...
import (
	...
	"aniverse/internal/library/autodownloader"
	"aniverse/internal/library/autoscanner"
	"aniverse/internal/library/fillermanager"
	...
	"aniverse/internal/mediaplayers/iina"
...
func NewApp(configOpts *ConfigOptions, selfupdater *updater.SelfUpdater) *App {
	...
	logger.Info().Msgf("app: Aniverse %s-%s", constants.Version, constants.VersionName)
	...
	app = &App{
		...
		SecondarySettings: struct {
			...
			Torrentstream *models.TorrentstreamSettings
			Debrid        *models.DebridSettings
		}{Mediastream: nil, Torrentstream: nil, Debrid: nil},
