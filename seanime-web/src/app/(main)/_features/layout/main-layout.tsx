...
import { AIToolsLauncher } from "@/app/(main)/_features/ai-features"
...
export const MainLayout = ({ children }: { children: React.ReactNode }) => {
    ...
    return (
        <>
            ...
            {/* AI Tools Launcher - Main AI interface available on all pages */}
            <AIToolsLauncher />
            
            {/* AI Floating Assistant - Floating bot button on all pages */}
            <AIFloatingAssistant />
