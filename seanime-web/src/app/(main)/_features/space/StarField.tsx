    ...
    >
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-white/60 text-sm">النوع</span>
                    <NeonBadge color="purple" size="sm">{selectedStar.type}</NeonBadge>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-white/60 text-sm">السنة</span>
                    <span className="text-white">{selectedStar.year}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-white/60 text-sm">التطابق</span>
      ...
      <div className="absolute bottom-4 left-4">
        <GlassCard className="p-3 space-y-2">
          <p className="text-xs text-white/60">دليل الألوان:</p>
...
function translateDNAKey(key: string): string {
  const translations: Record<string, string> = {
    ...
    powerSystem: 'القوة',
    conflictType: 'الصراع',
    romanceLevel: 'الرومانسية',
    comedyLevel: 'الكوميديا',
    darknessLevel: 'الظلام',
    mysteryLevel: 'الغموض',
  };
