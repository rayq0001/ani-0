...
const assets: AssetType[] = [
    {
        id: "1",
        name: "صوت سارة - صوت أنمي",
        description: "صوت أنثوي ناعم مثالي لشخصيات الرومانس",
        category: "voices",
        price: 500,
    ...
    },
    {
        id: "2",
        name: "برومبت سينمائي",
        description: "برومبت لإنتاج مشاهد أكشن درامية",
        category: "prompts",
        price: 150,
        author: "PromptMaster",
        downloads: 3400,
    ...
    {
        id: "3",
        name: "أفاتار التوأم الرقمي",
        description: "قالب avatar بأسلوب المانجا الكوري",
        category: "avatars",
        price: 300,
        author: "ManhwaArtist",
        downloads: 890,
    ...
    },
    {
        id: "4",
        name: "ثيم产业的 أيون",
        description: "ثيم بتدرج بنفسجي متحرك",
        category: "themes",
        price: 200,
        author: "ThemeCreator",
        downloads: 2100,
    ...
    },
    {
        id: "5",
        name: "إطار ذهبي فاخر",
        description: "إطار لتزيين الصفحات النادرة",
        category: "frames",
        price: 100,
        author: "FrameDesign",
        downloads: 5600,
    ...
    },
    {
        id: "6",
        name: "صوت أكشن شرس",
        description: "صوت ذكوري قوي للمشاهد الأكشن",
        category: "voices",
        price: 500,
        author: "VoicePro",
        downloads: 780,
...
const categories: { id: AssetCategory; name: string; icon: React.ReactNode }[] = [
    { id: "voices", name: "الأصوات", icon: <LuMic className="w-5 h-5" /> },
    { id: "prompts", name: "البرومبتات", icon: <LuSparkles className="w-5 h-5" /> },
    { id: "avatars", name: "الأفاتارات", icon: <LuImage className="w-5 h-5" /> },
    { id: "themes", name: "الثيمات", icon: <LuShoppingBag className="w-5 h-5" /> },
    { id: "frames", name: "الإطارات", icon: <LuStar className="w-5 h-5" /> },
]
    ...
    return (
        <div className="space-y-6">
            ...
            <GlassCard variant="medium" className="p-4">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-white">متجر Anyverse</h2>
                            <p className="text-sm text-white/50">مجموعة الأصول الرقمية</p>
                        </div>
                    </div>
            ...
            <GlassCardGradient gradientColors={["#8b5cf6", "#ec4899", "#f59e0b"]} className="p-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h3 className="text-xl font-bold text-white mb-2">أحتاج المزيد من AnyCoins؟</h3>
                        <p className="text-white/70">اشترِ رصيد إضافي واستمتع بمجموعة أكبر من الأصول</p>
                    </div>
                    <HolographicButton glowColor="gold">
