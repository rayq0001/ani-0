    ...
    const features = [
        {
            ...
            description: 'تجربة أنمي مخصصة حسب ثقافتك',
            icon: LuGlobe,
            color: 'from-blue-500 via-cyan-500 to-teal-500',
            items: [
                { flag: '🇸🇦', label: 'فصحى', desc: 'اللغة العربية الفصحى' },
                { flag: '🇸🇦', label: 'سعودي', desc: 'اللهجة السعودية' },
                { flag: '🇪🇬', label: 'مصري', desc: 'اللهجة المصرية' },
                { flag: '🇦🇪', label: 'خليجي', desc: 'لهجة الخليج' },
                { flag: '🇸🇾', label: 'شامي', desc: 'اللهجة الشامية' },
                { flag: '🇲🇦', label: 'مغربي', desc: 'اللهجة المغربية' },
            ]
        },
        {
            id: 'voice',
            title: 'الأصوات الذكية',
            description: 'شخصيات تتحدث بلهجتك المفضلة',
            icon: LuVolume2,
            color: 'from-violet-500 via-purple-500 to-fuchsia-500',
            items: [
                { icon: '👨', label: 'بطل', desc: 'صوت عميق وقوي' },
                { icon: '👩', label: 'بطلة', desc: 'صوت ناعم ورقيق' },
                { icon: '🦹', label: 'شرير', desc: 'صوت فخم وغامض' },
                { icon: '🤖', label: 'روبوت', desc: 'صوت مستقبلي' },
                { icon: '🎭', label: 'راوي', desc: 'صوت درامي' },
            ]
        },
        {
            id: 'visual',
            title: 'المنظور السينمائي',
            description: 'تحكم في زاوية الرؤية ثلاثية الأبعاد',
            icon: LuEye,
            color: 'from-pink-500 via-rose-500 to-red-500',
            items: [
                { icon: '👁️', label: 'عادي', desc: 'منظور المشاهد' },
                { icon: '🎮', label: 'FPV', desc: 'منظور الشخصية' },
                { icon: '🎬', label: 'سينمائي', desc: 'زوايا احترافية' },
                { icon: '🚁', label: 'جوي', desc: 'منظور علوي' },
            ]
        },
        {
            id: 'ost',
            title: 'الموسيقى التفاعلية',
            description: 'موسيقى تتغير حسب المشاعر',
            icon: LuMusic,
            color: 'from-amber-500 via-orange-500 to-yellow-500',
            items: [
                { icon: '🎵', label: 'حزينة', desc: 'للمشاهد المؤثرة' },
                { icon: '🥁', label: 'حماسية', desc: 'لمعارك الأكشن' },
                { icon: '🎹', label: 'هادئة', desc: 'للحظات الرومانسية' },
                { icon: '🎸', label: 'مشوقة', desc: 'للغموض والتشويق' },
            ]
        },
    ]
        ...
        <div className="min-h-screen bg-[#000000] relative overflow-hidden">
            ...
            <section className="relative z-10 overflow-hidden">
                <div className="relative container mx-auto px-4 py-20 max-w-6xl">
                    ...
                    >
                        ...
                        >
                            منصة أنمي عربية ذكية بتقنيات AI متقدمة
                        </motion.p>
            ...
            <section className="container mx-auto px-4 py-8 max-w-6xl">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                        { icon: LuBrain, label: 'نماذج AI', value: '5+' },
                        { icon: LuGlobe, label: 'اللهجات', value: '6' },
                        { icon: LuWand, label: 'المؤثرات', value: '50+' },
                        { icon: LuZap, label: 'الاستجابة', value: '<100ms' },
                    ].map((stat, index) => (
                        <motion.div
                            key={stat.label}
                ...
                >
                    ...
                    >
                        <h2 className="text-3xl font-bold text-white mb-4">
                            جاهز للتجربة العربية الجديدة؟
                        </h2>
                        <p className="text-gray-400 max-w-2xl mx-auto mb-8">
                            ابدأ رحلتك في عالم الأنمي باللغة العربية مع تقنيات AI متقدمة
                        </p>
