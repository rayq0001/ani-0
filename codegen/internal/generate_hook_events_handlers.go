...
func GenerateHandlerHookEvents(handlersJsonPath string, outputDir string) {
	...
	//f.WriteString("\t\"aniverse/internal/hook_resolver\"\n")

	imports := []string{
		"\"aniverse/internal/api/anilist\"",
		"\"aniverse/internal/api/tvdb\"",
		"\"aniverse/internal/continuity\"",
		"\"aniverse/internal/database/models\"",
		"\"aniverse/internal/debrid/client\"",
